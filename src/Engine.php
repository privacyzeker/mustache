...
class Engine
{
         ...
         *
         * @throws InvalidArgumentException If logger is not an instance of Mustache_Logger or Psr\Log\LoggerInterface
         *
        ...
        public function loadPartial($name)
        {
                try {
                        ...
                        } else if (isset($this->loader) && !$this->loader instanceof StringLoader) {
                                $loader = $this->loader;
                        } else {
